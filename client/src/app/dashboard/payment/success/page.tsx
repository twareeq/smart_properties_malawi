  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] max-w-lg mx-auto text-center space-y-6 px-4">
      ...
      <p className="text-gray-600 text-lg leading-relaxed">
        Thank you! Your transaction has been completed securely and
        your property is now confirmed.
        {tx_ref && (
          <span className="block mt-3 text-sm font-medium text-gray-400 bg-gray-50 py-1.5 px-3 rounded-md border border-gray-100 inline-block">
            Ref: {tx_ref}
          </span>
        )}
      </p>
      ...
      <div className="bg-blue-50/80 p-5 rounded-2xl w-full text-left flex gap-4 items-start border border-blue-100/50 mt-6 shadow-sm">
        ...
        <div>
          ...
          <p className="text-sm mt-1.5 text-blue-700/80 leading-relaxed">
            We've generated your official residential lease agreement.
            You can download it directly from your notifications or
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full pt-8">
        <Link href="/dashboard/receipts" className="flex-1">
          <Button className="w-full h-12 text-md shadow-sm">
        ...
        <Link href="/dashboard/notifications" className="flex-1">
          <Button
            variant="outline"
            className="w-full h-12 text-md border-gray-200 hover:bg-gray-50 text-gray-700 transition-colors shadow-sm"
          >
            Check Notifications{' '}
