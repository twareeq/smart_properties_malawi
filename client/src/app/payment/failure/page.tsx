...
export default function PaymentFailurePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen max-w-lg mx-auto text-center space-y-6 px-4 bg-gray-50">
      <div className="w-24 h-24 bg-red-50 rounded-full flex items-center justify-center mb-2 shadow-sm border border-red-100">
      ...
      <div className="bg-orange-50/80 p-5 rounded-2xl w-full text-left flex gap-4 items-start border border-orange-100/50 mt-6 shadow-sm">
        ...
        <div>
          ...
          <p className="text-sm mt-1.5 text-orange-800/80 leading-relaxed">
            If you keep experiencing issues, please verify your card details or try reaching out to your bank.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full pt-8">
        <Link href="/dashboard/bookings" className="flex-1">
          <Button className="w-full h-12 text-md gap-2 shadow-sm">
